 ...
 */
package team6829.common.motion_profiling;
...
public class MotionProfileController {
	 ...
	 * every 10ms.
	 */
	public static double [][]mPoints;
	public static int mNumPoints;
	 ...
	 */
	public MotionProfileController(TalonSRX talon) {
		_talon = talon;
		/*
	...
	public void control() {
		...
		if (_talon.getControlMode() != ControlMode.MotionProfile) {
			...
			Logging.process(_status, _pos, _vel, _heading);
		}
	}
	/**
	...
	private void startFilling() {
		...
		startFilling(mPoints, mNumPoints);
	}
	...
	private void startFilling(double[][] profile, int totalCnt) {
		...
		_talon.configMotionProfileTrajectoryPeriod(kBaseTrajPeriodMs, kTimeoutMs);
		...
		for (int i = 0; i < totalCnt; ++i) {
			...
			point.position = positionRot * kSensorUnitsPerRotation; //Convert Revolutions to Units
			point.velocity = velocityRPM * kSensorUnitsPerRotation / 600.0; //Convert RPM to Units/100ms
	 ...
	 * able to).
	 */
	public void startMotionProfile(double [][]points, int count) {
		points = mPoints;
		count = mNumPoints;
