 ...
 *
 */
public class MiddleStartLeftSwitchTwo extends CommandGroup {

    public MiddleStartLeftSwitchTwo(HashMap<String, PathFollower> forwardsPathFollowers, IntakeFlywheel intakeFlywheel, IntakeLift intakeLift, DriveTrain driveTrain, IntakeClaw intakeClaw) {
